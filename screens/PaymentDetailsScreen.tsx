            ...
            <div className="mt-8 bg-white dark:bg-gray-800 p-6 rounded-xl shadow-sm border">
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    <div>
                        ...
                        <input type="text" id="card-name" name="name" value={card.name} onChange={handleInputChange} required className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm dark:bg-gray-700 dark:border-gray-600"/>
                    </div>
                     <div>
                        <label htmlFor="card-number" className="block text-sm font-medium text-gray-700 dark:text-gray-300">Card Number</label>
                        <div className="relative">
                            <input type="text" id="card-number" name="number" value={card.number} onChange={handleInputChange} maxLength={19} placeholder="0000 0000 0000 0000" required className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm dark:bg-gray-700 dark:border-gray-600"/>
                     ...
                     <div className="grid grid-cols-2 gap-4">
                        <div>
                            ...
                            <input type="text" id="card-expiry" name="expiry" value={card.expiry} onChange={handleInputChange} maxLength={7} placeholder="MM / YY" required className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm dark:bg-gray-700 dark:border-gray-600"/>
                        </div>
                         <div>
                            <label htmlFor="card-cvc" className="block text-sm font-medium text-gray-700 dark:text-gray-300">CVC</label>
                            <input type="text" id="card-cvc" name="cvc" value={card.cvc} onChange={handleInputChange} maxLength={4} required className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm dark:bg-gray-700 dark:border-gray-600"/>
                        </div>
                    </div>
                    <button type="submit" className="w-full mt-4 py-2.5 px-4 bg-blue-600 text-white font-semibold rounded-lg hover:bg-blue-700 transition-colors">Save Card</button>
                </form>
            </div>
        </div>
    );
