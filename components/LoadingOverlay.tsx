...
export const LoadingOverlay: React.FC<LoadingOverlayProps> = () => {
    ...
    const statusMessages = agentStatusMessages.length > 0 ? agentStatusMessages : generationStatusMessages;
    const showChecklist = statusMessages.length > 0;
    const title = agentStatusMessages.length > 0 ? "Your Team of AI Agents are working..." : "Generating Your Creation...";
